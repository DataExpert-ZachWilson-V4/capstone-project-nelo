...
log_and_time "vault kv put secret/data/postgres username=\"nelomlb\" password=\"Pacmanbrooklyn33$\""
...
RESOURCE_GROUP_ID="/subscriptions/$ARM_SUBSCRIPTION_ID/resourceGroups/myResourceGroup"
STORAGE_ACCOUNT_ID="/subscriptions/$ARM_SUBSCRIPTION_ID/resourceGroups/myResourceGroup/providers/Microsoft.Storage/storageAccounts/$STORAGE_ACCOUNT_NAME"
VNET_ID="/subscriptions/$ARM_SUBSCRIPTION_ID/resourceGroups/myResourceGroup/providers/Microsoft.Network/virtualNetworks/myVnet"
SUBNET_ID="/subscriptions/$ARM_SUBSCRIPTION_ID/resourceGroups/myResourceGroup/providers/Microsoft.Network/virtualNetworks/myVnet/subnets/mySubnet"
NSG_ID="/subscriptions/$ARM_SUBSCRIPTION_ID/resourceGroups/myResourceGroup/providers/Microsoft.Network/networkSecurityGroups/myNsg"
NIC_ID="/subscriptions/$ARM_SUBSCRIPTION_ID/resourceGroups/myResourceGroup/providers/Microsoft.Network/networkInterfaces/myNic"
VM_ID="/subscriptions/$ARM_SUBSCRIPTION_ID/resourceGroups/myResourceGroup/providers/Microsoft.Compute/virtualMachines/myVM"
DISK_ID="/subscriptions/$ARM_SUBSCRIPTION_ID/resourceGroups/myResourceGroup/providers/Microsoft.Compute/disks/myOsDisk"
POSTGRES_SERVER_ID="/subscriptions/$ARM_SUBSCRIPTION_ID/resourceGroups/myResourceGroup/providers/Microsoft.DBforPostgreSQL/servers/nelomlb-postgres-server"
...
if az resource show --ids "$POSTGRES_SERVER_ID" &> /dev/null; then
  ...
  import_resource "azurerm_postgresql_database.airflow_db" "/subscriptions/$ARM_SUBSCRIPTION_ID/resourceGroups/myResourceGroup/providers/Microsoft.DBforPostgreSQL/servers/nelomlb-postgres-server/databases/airflow"
  import_resource "azurerm_postgresql_database.superset_db" "/subscriptions/$ARM_SUBSCRIPTION_ID/resourceGroups/myResourceGroup/providers/Microsoft.DBforPostgreSQL/servers/nelomlb-postgres-server/databases/superset"
  import_resource "azurerm_postgresql_database.hive_db" "/subscriptions/$ARM_SUBSCRIPTION_ID/resourceGroups/myResourceGroup/providers/Microsoft.DBforPostgreSQL/servers/nelomlb-postgres-server/databases/hive"
  import_resource "azurerm_postgresql_database.mlflow_db" "/subscriptions/$ARM_SUBSCRIPTION_ID/resourceGroups/myResourceGroup/providers/Microsoft.DBforPostgreSQL/servers/nelomlb-postgres-server/databases/mlflow"
  import_resource "azurerm_postgresql_database.haystack_db" "/subscriptions/$ARM_SUBSCRIPTION_ID/resourceGroups/myResourceGroup/providers/Microsoft.DBforPostgreSQL/servers/nelomlb-postgres-server/databases/haystack"
  import_resource "azurerm_postgresql_database.zookeeper_db" "/subscriptions/$ARM_SUBSCRIPTION_ID/resourceGroups/myResourceGroup/providers/Microsoft.DBforPostgreSQL/servers/nelomlb-postgres-server/databases/zookeeper"
  import_resource "azurerm_postgresql_database.kafka_db" "/subscriptions/$ARM_SUBSCRIPTION_ID/resourceGroups/myResourceGroup/providers/Microsoft.DBforPostgreSQL/servers/nelomlb-postgres-server/databases/kafka"
  import_resource "azurerm_postgresql_database.pgadmin_db" "/subscriptions/$ARM_SUBSCRIPTION_ID/resourceGroups/myResourceGroup/providers/Microsoft.DBforPostgreSQL/servers/nelomlb-postgres-server/databases/pgadmin"
  import_resource "azurerm_postgresql_database.trino_db" "/subscriptions/$ARM_SUBSCRIPTION_ID/resourceGroups/myResourceGroup/providers/Microsoft.DBforPostgreSQL/servers/nelomlb-postgres-server/databases/trino"
  import_resource "azurerm_postgresql_database.qdrant_db" "/subscriptions/$ARM_SUBSCRIPTION_ID/resourceGroups/myResourceGroup/providers/Microsoft.DBforPostgreSQL/servers/nelomlb-postgres-server/databases/qdrant"
  import_resource "azurerm_postgresql_database.spark_db" "/subscriptions/$ARM_SUBSCRIPTION_ID/resourceGroups/myResourceGroup/providers/Microsoft.DBforPostgreSQL/servers/nelomlb-postgres-server/databases/spark"
fi
